...
{
    /// <inheritdoc />
    public partial class InitialCleanSetupWithIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 10, 200m, "Golden Circle" },
                    { 2, 1, 50, 50m, "Standing" },
                    { 3, 1, 60, 60m, "Seated" },
                    { 4, 2, 1000, 200m, "Golden Circle" },
                    { 5, 2, 19000, 50m, "Standing" },
                    { 6, 2, 20000, 60m, "Seated" },
                    { 7, 3, 0, 100m, "Golden Circle" },
                    { 8, 3, 0, 28m, "Standing" },
                    { 9, 3, 0, 32m, "Seated" },
                    { 10, 4, 2000, 28m, "Standing" },
                    { 11, 4, 1800, 32m, "Seated" },
                    { 12, 5, 2000, 28m, "Standing" },
                    { 13, 5, 7800, 32m, "Seated" },
                    { 14, 6, 400, 150m, "Golden Circle" },
                    { 15, 6, 4000, 65m, "Standing" },
                    { 16, 6, 4000, 55m, "Seated" },
                    { 17, 7, 1000, 124m, "Golden Circle" },
                    { 18, 7, 20000, 67m, "Standing" },
                    { 19, 8, 2000, 36m, "Standing" },
                    { 20, 8, 7800, 40m, "Seated" }
                });
